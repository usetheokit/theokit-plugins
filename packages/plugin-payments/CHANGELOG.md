...
- 035e354: The Stripe webhook endpoint as a controller your app extends, instead of a function you wire and translate by hand.
...
- 570e003: Narrow the `stripe` peer to `^14.8.0` — the range the package can actually compile against.
