...
- acdab45: `DbCommand.buildArgs()` takes no argument, the documented wiring names where its options come from, and the published types no longer cite issues that belong to other work.
